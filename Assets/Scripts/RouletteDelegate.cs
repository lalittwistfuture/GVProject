...
namespace Roullet
{
    public class RouletteDelegate : MonoBehaviour
    {
        ...
        public delegate void OptionSelected(string tag, GameObject obj);
        public static event OptionSelected onOptionSelected;
        public static void optionClick(string tag, GameObject obj)
        {
            if (onOptionSelected != null)
            {
                onOptionSelected(tag, obj);
            }
        }
        ...
        public delegate void NumberSelected(List<int> number, GameObject obj);
        public static event NumberSelected onNumberSelected;
        public static void numberClick(List<int> number, GameObject obj)
        {
            if (onNumberSelected != null)
            {
                onNumberSelected(number, obj);
            }
        }
