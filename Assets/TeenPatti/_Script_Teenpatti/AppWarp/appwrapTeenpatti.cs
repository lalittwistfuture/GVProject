...
{
    // private string appKey = "23e0b14c-062e-4b8d-9";
    // private string ipAddress = "139.59.92.98";
    // private int port = 12358;

      private string appKey = "47356976-2591-45c6-8";
    private string ipAddress = "208.109.9.181";
    private int port = 12348;

    // private string appKey = "ce3ea5e4-49d5-4e35-a";
    ...
    public static void gameRequest()
    {
        ...
        dic.Add(PlayerTagsTeenPatti.DISPLAY_NAME, PlayerPrefs.GetString(PlayerDetails.RealName));
        dic.Add(PlayerTagsTeenPatti.PROFILE_PIC, PlayerPrefs.GetString(PlayerDetails.Picture));
        dic.Add(PlayerTagsTeenPatti.TOTAL_COINS, PlayerPrefs.GetString("InHand"));
    ...
    public static void sendCardInHand(JSONNode card)
    {
        ...
        dic.Add(PlayerTagsTeenPatti.PLAYER_ID, PlayerPrefs.GetString(PrefebTagsTeenpatti.PLAYER_ID));
        appwrapTeenpatti.sendChat(dic.ToString());
    }
    ...
    public static void sideShowAcceptance(string to, bool accept)
    {
        ...
        dic.Add(ServerTagsTeenpatti.SIDE_SHOW_TO_ID, PlayerPrefs.GetString(PrefebTagsTeenpatti.PLAYER_ID));
    ...
    public static void LeftRoom()
    {
        ...
        data.Add(PlayerTagsTeenPatti.PLAYER_ID, PlayerPrefs.GetString(PrefebTagsTeenpatti.PLAYER_ID));
        appwrapTeenpatti.sendChat(data.ToString());
    }
    ...
    public void Connection()
    {
        try
        {
            ...
            WarpClient.GetInstance().Connect(PlayerPrefs.GetString(PrefebTagsTeenpatti.PLAYER_ID), "");
