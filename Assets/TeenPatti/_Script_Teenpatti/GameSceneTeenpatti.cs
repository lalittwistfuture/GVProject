...
public class GameSceneTeenpatti : MonoBehaviour
{
    ...
    public GameObject addCoinPanel;
    ...
    public void showAddCoinPanel(){
        ...
        addCoinPanel.GetComponent<AddCoinToGame>().setInitialCoin(int.Parse(currentPlayer.totalCoin.text));
    }
    ...
    void Start()
    {
        ...
        if (GameControllerTeenPatti.variation == false)
        {
