...
namespace Ludo
{
    ...
    public class GameConstantData : MonoBehaviour
    {
        ...
        //public static List<FacebookFrndDetails> MyFriendsList = new List<FacebookFrndDetails>();
        ...
        public static void showToast(Transform trans, string text)
        {
            ...
            if (pop == null)
            {
                pop = Instantiate(Resources.Load("_prefeb/PopUp", typeof(GameObject))) as GameObject;//Resources.Load ("_prefeb/PopUp") as GameObject;
            }
            if (pop)
            {
