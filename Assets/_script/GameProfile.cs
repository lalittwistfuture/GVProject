...
namespace Ludo
{
    public class GameProfile : MonoBehaviour
    {
        ...
        void updatePopup()
        {
            ...
            playerName.GetComponent<Text>().text = PlayerPrefs.GetString(GetPlayerDetailsTags.PLAYER_NAME);
            playerCoin.GetComponent<Text>().text = PlayerPrefs.GetString(GetPlayerDetailsTags.PLAYER_COIN);
            string profilePic = PlayerPrefs.GetString(GetPlayerDetailsTags.PLAYER_IMAGE);
            //print ("pic is " + profilePic);
