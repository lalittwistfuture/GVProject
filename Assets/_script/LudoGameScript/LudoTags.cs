...
namespace Ludo
{
    ...
    public class LudoTags
    {
        ...
        public const string GOTI_LIMIT = "GOTI_LIMIT";
        ...
        public const string MY_COLOR = "MY_COLOR";
        public const int ONE_ONE = 1;
        public const int ONE_FOUR = 2;
    }
    public class GameTags
    {
        ...
        public const string VIBRATION_ON = "VIBRATION_ON";
...
public class ServerTags
    {
        ...
        public const string TOTAL_DICE = "TOTAL_DICE";
        ...
        public const string JOIN_USER = "JOIN_USER";
    ...
    public class Tags
    {
      ...
      //  public const string URL = "http://localhost/CasinoBlueMoon/app/ludo/index.php";
        public const string URL = "https://casinobluemoon.com/app/ludo/index.php";
       // public const string URL = "http://deathwish.in/CasinoBlueMoon/ludo/index.php";//"http://deathwish.in/ludo_nainital/";
        public const string TAG = "TAG";
       
        public const string CHALLENGE = "CHALLENGE";
        public const string PRIVACY_POLICY = "PRIVACY_POLICY";
        public const string TERMS_N_CONDITION = "TERMS_N_CONDITION";
        public const string HOW_TO_WIN = "HOW_TO_WIN";
        public const string ABOUT_US = "ABOUT_US";
        public const string REFERRAL_COIN_FOR_OLD_PLAYER = "REFERRAL_COIN_FOR_OLD_PLAYER";
        public const string REFERRAL_COIN_FOR_NEW_PLAYER = "REFERRAL_COIN_FOR_NEW_PLAYER";
        ...
        public const string TO_POSITION = "TO_POSITION";
        public const string WINNER_PLAYER = "WINNER_PLAYER";
        public const string LOSS_GAME = "LOSS_GAME";
    }
